...
if(isset($_POST['update'])){
  $query =
  '
  UPDATE Ville SET  nom=?, resume=?, pays=?, image=?, id_continent=? WHERE id=?

  ';

  $resultSet = $pdo->prepare($query);
  $resultSet->execute([$_POST['nom'], $_POST['resume'], $_POST['pays'], $_POST['image'], $_POST['id_continent'], $_GET['id']]);

  header('Location: ville-list.php');
}
                      ...
                      <ul class="nav navbar-nav mai-top-nav header-right-menu">
                        ...
                        <li class="nav-item">
                          <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                            ...
                            <span class="admin-name">Menu</span>
                  ...
                  <ul class="mobile-menu-nav">
                    <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                      <ul class="collapse dropdown-header-top">
                        ...
                        <li><a href="product-list.php">Liste des bières</a></li>
                        <li><a href="ville-list.php">Liste des villes</a></li>
                    ...
                    <div class="row">
                      <form class="generic-form" method="post">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <div class="review-content-section">
                            <div class="input-group mg-b-pro-edt">
                              ...
                              <input type="text" class="form-control" placeholder="Nom de la ville" name="nom" value="<?= $post['nom'] ?>">
                            </div>
                            ...
                            <div class="input-group mg-b-pro-edt">
                              ...
                              <input type="text" class="form-control" placeholder="Pays" name="pays" value="<?= $post['pays'] ?>">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <div class="review-content-section">
                            <div class="input-group mg-b-pro-edt">
                              ...
                              <input type="text" class="form-control" placeholder="Image ville" name="image" value="<?= $post['image'] ?>">
                            </div>


                            <label name="id_continent" value="<?= $post['id_continent'] ?>">Indiquer le continent d'appartenance</label>
                            <select name="id_continent" value="<?= $post['id_continent'] ?>" class="form-control pro-edt-select form-control-primary">
                              <?php foreach ($cats as $cat): ?>
                                <option value="<?= $cat['id'] ?>"  <?php if($cat['id'] == $post['id_continent']){echo 'selected';} ?>><?= $cat['nom_cont'] ?></option>
                                <?php endforeach ?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <a href="ville-list.php"><button type="button" class="btn btn-warning waves-effect waves-light">Annuler</a>
                          </button>
                          </div>
                        </div>
