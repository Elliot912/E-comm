                  ...
                  <?php foreach ($clients as $client): ?>
                    <tbody>
                      <tr>
                        ...
                        <td><?= $client['tel'] ?></td>
                        <td><?= $client['date'] ?></td>
                        <td><button formaction="client-edit.php?id=<?= $client['id'] ?>" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                        </td>
                      </tr>
                    </tbidy>
                  <?php endforeach ?>
