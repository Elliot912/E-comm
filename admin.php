                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="add-admin.php">Ajout administrateur</a>
                            </div>
                            <table>
                                <tr>
                                  ...
                                  <?php foreach ($posts as $post): ?>
                                    ...
                                    <td><?= $post['password'] ?></td>
                                    <td>
                                        <button formaction="admin-edit.php?id=<?= $post['id'] ?>" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                    </td>
                                  </tr>
                                  <?php endforeach ?>
