...
if(isset($_POST['update'])){
  $query =
  '
  UPDATE Admin SET  user=?, password=? WHERE id=?

  ';

  $resultSet = $pdo->prepare($query);
  $resultSet->execute([$_POST['user'], $_POST['password'], $_GET['id']]);
...
SELECT *
FROM Detailscmd
WHERE id_commande IN (SELECT id
FROM Commande
WHERE
id_client = ?)
';
...
'
SELECT
CONCAT(Client.id) as clientid,
CONCAT (Commande.id) as cmdid,
date_cmd,
nom,
prenom,
user,
          ...
          <ul class="metismenu" id="menu1">
            <li class="active">
              ...
              <ul class="submenu-angle" aria-expanded="true">
                  <li><a title="Accueil" href="index.php"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Accueil admin</span></a></li>
                  <li><a title="Accueil" href="admin.php"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste admin</span></a></li>
                  <li><a title="Liste bières" href="product-list.php"><i class="fa fa-female sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste des bières</span></a></li>
                  <li><a title="Liste bières" href="clients.php"><i class="fa fa-female sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste des clients</span></a></li>
                  <li><a title="Liste ville" href="ville-list.php"><i class="fa fa-heart-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste des villes</span></a></li>
                  <li><a title="Liste ville" href="cmd.php"><i class="fa fa-heart-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste des commandes</span></a></li>
                            ...
                            <form id="loginForm" method="post">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input required class="form-control" placeholder="Renseignez un numéro" name="tel" value="<?= $info['tel'] ?>">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Votre adresse de livraison</label>
                                        <input required class="form-control" placeholder="Adressse de livraison" name="adresse_livraison" value="<?= $info['adresse_livraison'] ?>">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Complément adresse de livraison</label>
                                        <input required class="form-control" placeholder="Complément adressse de livraison" name="plus_livraison" value="<?= $info['plus_livraison'] ?>">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Ville de livraison</label>
                                        <input required class="form-control" placeholder="Ville de livraison" name="ville_livraison" value="<?= $info['ville_livraison'] ?>">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Code postal de livraison</label>
                                        <input required class="form-control" placeholder="Code postal de livraison" name="cp_livraison" value="<?= $info['cp_livraison'] ?>">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Votre adresse de facturation</label>
                                        <input required class="form-control" placeholder="Adressse de facturation" name="adresse_facturation" value="<?= $info['adresse_facturation'] ?>">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Complément adresse de facturation</label>
                                        <input required class="form-control" placeholder="Complément adressse de facturation" name="plus_facturation" value="<?= $info['plus_facturation'] ?>">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Ville de facturation</label>
                                        <input required class="form-control" placeholder="Ville de facturation" name="ville_facturation" value="<?= $info['ville_facturation'] ?>">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Code postal de facturation</label>
                                        <input required class="form-control" placeholder="Code postal de facturation" name="cp_facturation" value="<?= $info['cp_facturation'] ?>">
                                    </div>
                                ...
                                <div class="text-center">
                                    <button class="btn btn-success loginbtn" value="enter" name="enter">Enregistrer</button>
                                    <a href="clients.php"  class="btn btn-default">Annuler</a>
                                    <button class="btn btn-success loginbtn" value="suppr" name="suppr">Supprimer le client</button>
                                </div>
                            </form>
                            <a href="client-commande.php?id=<?= $info['clientid'] ?>" class="btn btn-success loginbtn" value="" name="commandes">Voir les commandes</a>
                        </div>
                    </div>
                </div>
                </div>
