                    ...
                    <div class="row">
                      <form class="generic-form" method="post">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <div class="review-content-section">
                            <div class="input-group mg-b-pro-edt">
                              ...
                              <input type="text" class="form-control" placeholder="Nom de l'admin'" name="user" value="<?= $post['user'] ?>">
                            </div>

                            <div class="input-group mg-b-pro-edt">
                              <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                              <input type="text" class="form-control" placeholder="password" name="password" value="<?= $post['password'] ?>">
                            </div>
                          </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <a href="admin.php"><button type="button" class="btn btn-warning waves-effect waves-light">Annuler</a>
                          </button>
                          </div>
                        </div>
