...
session_start();
 ...
 '
SELECT
  nom, pays, resume, image, id_continent
FROM
  Ville
  ...
  <?php include 'header.php'; ?>
 	...
 	<div class="section">
 		...
 		<div class="container">
            ...
            <br>
            <p>La ville de <?= $Villes['nom'] ?> se trouve en <?= getNomContinent($Villes['id_continent']) ?>, et plus particulièrement en <?= $Villes['pays'] ?></p>
            <br>
