...
'
  ...
  FROM
    Commande, Client
  WHERE
   Commande.id_client = Client.id AND Client.id = ?
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="product-list.html">Liste des bières
                                                </a></li>
                            ...
                            <table>
                                <tr>
                                  ...
                                  <?php foreach ($orders as $order): ?>
                                    ...
                                    <td><?= $order['user'] ?></td>
                                    <td><button formaction="detail-commande.php?id=<?= $order['cmdid'] ?>" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                    </td>
                                  </tr>
                                  <?php endforeach ?>
