                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <h4>Liste des bières</h4>
                            <div class="add-product">
                                <a href="add-biere.php">Ajout bière</a>
                            </div>
                            <table>
                                <tr>
                                    <th>Image</th>
                                  ...
                                  <?php foreach ($posts as $post): ?>
                                    ...
                                    <td><?= $post['ventes'] ?></td>
                                    <td><?= $post['prix']* $post['ventes'] ?></td>
                                    <td><?= $post['qte'] ?></td>
                                    <td><?= $post['prix'] ?></td>
                                    <td><?= $post['id_categorie'] ?></td>
                                    <td>
                                        <button formaction="product-edit.php?id=<?= $post['id'] ?>" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                    </td>
                                  </tr>
                                  <?php endforeach ?>
