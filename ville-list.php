                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="product-list.html">Liste des bières</a></li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="add-ville.php">Ajout ville</a>
                            </div>
                            <table>
                                <tr>
                                    <th>Image de la ville</th>
                                    <th>Nom de la ville</th>
                                    <th>Résumé de la ville</th>
                                    <th>Pays</th>
                                    <th>Continent</th>
                                    <th>Action</th>
                                </tr>
                                  <?php foreach ($posts as $post): ?>
                                    ...
                                    <td><?= $post['resume'] ?></td>
                                    <td><?= $post['pays'] ?></td>
                                    <td><?php echo getNomContinent($post['id_continent']); ?></td>
                                    <td>
                                        <button formaction="ville-edit.php?id=<?= $post['id'] ?>" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                    </td>
                                  </tr>
                                  <?php endforeach ?>
