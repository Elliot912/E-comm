...
date_cmd
FROM
Client, Commande, Detailscmd
WHERE
Commande.id = Detailscmd.id_commande AND Commande.id_client = Client.id AND Commande.id = ?
';
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="review-tab-pro-inner">
                <ul id="myTab3" class="tab-review-design">
                  <li class="active"><a href="login.php">Détails de la commande</a></li>
                </ul>
                      ...
                      <form class="generic-form" method="post">
                            ...
                            <table class="table table-striped table-bordered">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col-0">Identité du client</th>
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td><?= $post['email'] ?></td>
                                  <td><?= $post['tel'] ?></td>
                                  <td><?= $post['adresse_livraison'].$post['plus_livraison'].$post['ville_facturation'].$post['cp_livraison'] ?></td>
                                  <td><?= $post['adresse_facturation'].$post['plus_facturation'].$post['ville_facturation'].$post['cp_facturation'] ?></td>
                                </tr>
                              </tbody>
                            </table>
                            ...
                            <table class="table table-striped table-bordered">
                              ...
                              <tbody>
                                <?php foreach ($cmds as $cmd): ?>
                                  <tr>
                                    <td><?= $cmd['id_produit'] ?></td>
                                    <td><?= $cmd['prix'] ?></td>
                                    <td><?= $cmd['qte'] ?></td>
                                    <td> <?= $cmd['prix']*$cmd['qte'] ?></td>
                                  </tr>
                                <?php endforeach ?>

                                <tr>
                                  <td colspan=3 style="text-align: right";>Prix total de la commande (TVA incluse)</td>
                                  <td><?= $total['ttc'] ?></td>
                                </tbody>
                              </tr>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                            ...
                            <a href="cmd.php" type="button" class="btn btn-warning waves-effect waves-light">Annuler
                            </a>
                          </div>
                        </div>
