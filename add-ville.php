...
if(isset($_POST['Add'])){
  ...
  $resultSet->execute([$_POST['nom'], $_POST['resume'], $_POST['pays'], $_POST['image'], $_POST['id_continent']]);
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="review-tab-pro-inner">
                <ul id="myTab3" class="tab-review-design">
                  <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i>Ajout de ville</a></li>
                </ul>
                <div id="myTabContent" class="tab-content custom-product-edit">
                  <div class="product-tab-list tab-pane fade active in" id="description">
                    <div class="row">
                      <form class="generic-form" method="post" action="add-ville.php">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <div class="review-content-section">
                            <div class="input-group mg-b-pro-edt">
                              <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                              <input type="text" class="form-control" placeholder="Nom de la ville" name="nom">
                            </div>
                            ...
                            <!-- <div class="input-group mg-b-pro-edt">
                              <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                              <input type="text" class="form-control" placeholder="Continent" name="continent">
                            </div> -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <div class="review-content-section">
                            ...
                            <label name="id_continent">Noter le continent</label>
                            <select name="id_continent" class="form-control pro-edt-select form-control-primary">
                              <?php foreach ($cats as $cat): ?>
                                <option value="<?= $cat['id'] ?>"><?= $cat['nom_cont'] ?></option>
                                <?php endforeach ?>
