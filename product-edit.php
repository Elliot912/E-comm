...
if(isset($_POST['update'])){
  $query =
  '
  UPDATE Produit SET  titre=?, description=?, image=?, prix=?, qte=?, id_categorie=?, resume=? WHERE id=?

  ';

  $resultSet = $pdo->prepare($query);
  $resultSet->execute([$_POST['titre'], $_POST['description'], $_POST['image'], $_POST['prix'], $_POST['qte'], $_POST['id_categorie'], $_POST['resume'], $_GET['id']]);
          ...
          <ul class="metismenu" id="menu1">
            <li class="active">
              ...
              <ul class="submenu-angle" aria-expanded="true">
                  ...
                  <li><a title="Liste bières" href="product-list.php"><i class="fa fa-female sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste des clients</span></a></li>
                  <li><a title="Liste ville" href="clients.php"><i class="fa fa-heart-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste des commandes</span></a></li>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="review-tab-pro-inner">
                <ul id="myTab3" class="tab-review-design">
                  <li class="active"><a href="login.php"><i class="fa fa-pencil" aria-hidden="true"></i> Product Edit</a></li>
                </ul>
                      ...
                      <form class="generic-form" method="post">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <div class="review-content-section">
                            <div class="input-group mg-b-pro-edt">
                              ...
                              <input type="text" class="form-control" placeholder="Nom de la bière" name="titre" value="<?= $post['titre'] ?>">
                            </div>

                            <div class="input-group mg-b-pro-edt">
                              <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                              <input type="text" class="form-control" placeholder="resume" name="resume" value="<?= $post['resume'] ?>">
                            </div>
                            <div class="input-group mg-b-pro-edt">
                              <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                              <input type="text" class="form-control" placeholder="Prix vente unitaire" name="prix" value="<?= $post['prix'] ?>">
                            </div>
                            <div class="input-group mg-b-pro-edt">
                              <span class="input-group-addon"><i class="fa fa-qrcode" aria-hidden="true"></i></span>
                              <input type="text" class="form-control" placeholder="Stock" name="qte" value="<?= $post['qte'] ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <div class="review-content-section">
                            <div class="input-group mg-b-pro-edt">
                              ...
                              <input type="text" class="form-control" placeholder="Product Description" name="description" value="<?= $post['description'] ?>">
                            </div>
                            <div class="input-group mg-b-pro-edt">
                              <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                              <input type="text" class="form-control" placeholder="Image" name="image" value="<?= $post['image'] ?>">
                            </div>

                            <label name="id_categorie" value="<?= $post['id_categorie'] ?>">Noter la couleur de la bière</label>
                            <select name="id_categorie" value="<?= $post['id_categorie'] ?>" class="form-control pro-edt-select form-control-primary">
                              <?php foreach ($cats as $cat): ?>
                                <option value="<?= $cat['id'] ?>"  <?php if($cat['id'] == $post['id_categorie']){echo 'selected';} ?>><?= $cat['titre'] ?></option>
                                <?php endforeach ?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                            <button type="submit" class="btn btn-primary waves-effect waves-light m-r-10" name="update" value="update">Enregistrer
                            </button>
                            <button  type="submit" class="btn btn-warning waves-effect waves-light" name="suppr" value="suppr">Supprimer
                            </button>

                          </button>
                          <a href="product-list.php"><button type="button" class="btn btn-warning waves-effect waves-light">Annuler</a>
                          </button>
                          </div>
                        </div>
